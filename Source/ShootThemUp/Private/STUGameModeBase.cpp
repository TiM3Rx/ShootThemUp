...
void ASTUGameModeBase::GameTimerUpdate()
{
    ...
    // const auto TimerRate = GetWorldTimerManager().GetTimerRate(GameRoundTimerHandle);  TimerRate is broken in this code cause
    // RoundCountDown -= TimerRate;                                                       float value deviding on int value
